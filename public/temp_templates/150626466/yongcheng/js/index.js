...
$(document).ready(function(){
	// 滚轮开始
	$('#prizes .photo1 .photos-content').jCarouselLite({
		btnPrev: '#prizes .photos1 a.photos-prev',
		btnNext: '#prizes .photos1 a.photos-next',
		visible: 3,
		auto: 3000,
		speed: 1000
	});
	$('#prizes .photo2 .photos-content').jCarouselLite({
		btnPrev: '#prizes .photo2 a.photos-prev',
		btnNext: '#prizes .photo2 a.photos-next',
		visible: 3,
		auto: 3000,
		speed: 1000
	});
